...
const WorkerUpdate = () => {
  ...
  const {_id, workerName, designation, emailAddress, profile, mobileNumber, educationQualification} = location.state
  ...
  updateformData.append("workerName", teacherData.workerName);
  ...
  return (
    <form onSubmit={handleSubmit} encType='multipart/form-data' className="create_teacher">
      ...
      <div className="create_section_left">
        ...
        <p>Worker Name</p>
        <input type="text" name='workerName' onChange={handleChange} value={teacherData.workerName ? teacherData.workerName : workerName} />
      ...
      <div className="create_section_right">
        ...
        <input className='submit_btn' type='submit' value={'Update Worker'} />
