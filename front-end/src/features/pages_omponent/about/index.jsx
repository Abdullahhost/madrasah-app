  ...
  return (
    <div className='about_section'>
      ...
      <Grid container direction={'column'} alignItems={'center'} justifyContent={'center'} gap={2}>
        <Grid item width={'min(100% - .1rem, 80ch)'} className='about_section_paragraph' >
          <Typography variant='overline' sx={{ fontSize: '1.6rem !important', }}>
            our Mission statement
          </Typography><br />
          <Typography  variant='caption' sx={{fontSize: '1rem !important', fontWeight: 'bolder !important',color: '#555 !important'}}>✔About Our Madrashah </Typography>
        ...
        <Grid item width={'min(100% - .1rem, 80ch)'} className='about_section_paragraph'>
          <Typography  variant='caption' sx={{fontSize: '1rem !important', fontWeight: 'bolder !important',color: '#555 !important'}}>✔Our Mission </Typography>
        ...
        <Grid item width={'min(100% - .1rem, 80ch)'} className='about_section_paragraph'>
          <Typography  variant='caption' sx={{fontSize: '1rem !important', fontWeight: 'bolder !important',color: '#555 !important'}}>✔Our Distinctive Approach</Typography>
        ...
        <Grid item width={'min(100% - .1rem, 80ch)'} className='about_section_paragraph'>
          <Typography  variant='caption' sx={{fontSize: '1rem !important', fontWeight: 'bolder !important',color: '#555 !important'}}>✔Faculty Excellence</Typography>
        ...
        <Grid item width={'min(100% - .1rem, 80ch)'} className='about_section_paragraph'>
          <Typography  variant='caption' sx={{fontSize: '1rem !important', fontWeight: 'bolder !important',color: '#555 !important'}}>✔Community and Diversity</Typography>
        ...
        <Grid item width={'min(100% - .1rem, 80ch)'} className='about_section_paragraph'>
          <Typography  variant='caption' sx={{fontSize: '1rem !important', fontWeight: 'bolder !important',color: '#555 !important'}}>✔Join Us</Typography>
