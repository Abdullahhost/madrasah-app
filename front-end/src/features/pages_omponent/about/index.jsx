...
const lightDarkMode = useSelector(state => state.dark.dark)
  return (
    <div
      ...
      <Grid data-aos="zoom-in" data-aos-duration="1000" container direction={'column'} alignItems={'center'} gap={3} marginBottom={5}>
      ...
      <Grid container direction={'column'} alignItems={'center'} justifyContent={'center'} gap={2}>
        <Grid data-aos="fade-left" data-aos-duration="1000" item width={'min(100% - .1rem, 80ch)'} className={lightDarkMode ? "dark_about_section_paragraph" : "about_section_paragraph" } >
        ...
        <Grid   data-aos="fade-right" data-aos-duration="1000"item width={'min(100% - .1rem, 80ch)'} className={lightDarkMode ? "dark_about_section_paragraph" : "about_section_paragraph" }>
